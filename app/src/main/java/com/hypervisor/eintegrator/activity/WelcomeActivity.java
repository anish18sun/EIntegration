...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void playSound() {
        ...
        if (language.equals(Constants.LAN_ENG)) {
            intentSound.putExtra(Constants.FILE_RAW, R.raw.welcome_to_eintegration_app_english);
        } else if (language.equals(Constants.LAN_HINDI)) {
            intentSound.putExtra(Constants.FILE_RAW, R.raw.namaste_aapka_swagat_hai_hindi);
        } else {
            intentSound.putExtra(Constants.FILE_RAW, R.raw.tharo_swagat_che_marwari);
        }
